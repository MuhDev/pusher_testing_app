...
class _MyAppState extends State<MyApp> {
  ...
  String _log = 'output:\n';
  final _apiKey = TextEditingController(text: "030b522bdbdca49cd4d8");
  final _cluster = TextEditingController(text: "eu");
  final _channelName = TextEditingController(text: "ask_yor_doctor_1");
  ...
  void onConnectPressed() async {
    ...
    try {
      await pusher.init(
          ...
          authParams: {
            'headers': {
              ...
              'Authorization':
                  'Bearer 97de8edc161ac1ecee05490caa576555e684bb4bc8cee3c001a129b2a835c672'
            },
            'params': {
              "PatientId": "1",
              "PatientName": "Basem",
              "DoctorId": "1",
              "DoctorName": "Mohoooooooo",
              "ChannelToken": "ddddddddddddddddeeeeeeeeeeeeee",
              "Hasdialled": "true",
            }
          },
          authEndpoint:
      ...
      channel = await pusher.subscribe(channelName: _channelName.text);
    } catch (e) {
      log("ERROR: $e");
    }
  }
  ...
  dynamic onAuthorizer(String channelName, String socketId, dynamic options) {
    ...
    print(socketId);
    return {
      "auth": "Authorization:Bearer 97de8edc161ac1ecee05490caa576555e684bb4bc8cee3c001a129b2a835c672",
  ...
  void onTriggerEventPressed() async {
    ...
    pusher.trigger(PusherEvent(
        ...
        data: json.encode({"message": _data.text})));
  }
